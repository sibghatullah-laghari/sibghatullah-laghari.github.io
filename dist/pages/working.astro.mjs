import { c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as addAttribute, u as unescapeHTML } from '../chunks/astro/server_D57DNOQO.mjs';
import 'kleur/colors';
import { $ as $$BaseLayout } from '../chunks/BaseLayout_C_UA5XDo.mjs';
export { renderers } from '../renderers.mjs';

const $$Working = createComponent(($$result, $$props, $$slots) => {
  const services = [
    {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "What I Do \u2014 Sibghatullah Laghari" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="sec" style="background:radial-gradient(ellipse 70% 50% at 80% 0,rgba(99,102,241,.1) 0%,transparent 60%),var(--bg);"> <div class="wrap"> <!-- Header --> <div style="text-align:center;max-width:42rem;margin:0 auto 4rem;"> <span class="s-eyebrow">Capabilities</span> <h1 class="s-title">What I Build</h1> <p class="s-desc" style="margin:0 auto;">Focused on backend engineering &mdash; the logic, security, and data layer that powers applications. Here's what I bring to a project.</p> </div> <!-- Services Grid --> <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1.5rem;"> ${services.map((s) => renderTemplate`<div class="card" style="display:flex;flex-direction:column;gap:1rem;"> <!-- Icon box --> <div${addAttribute(`width:2.75rem;height:2.75rem;border-radius:.625rem;background:${s.color}18;border:1px solid ${s.color}30;display:flex;align-items:center;justify-content:center;color:${s.color};flex-shrink:0;`, "style")}>${unescapeHTML(s.icon)}</div> <!-- Content --> <div> <h3 style="font-size:1rem;font-weight:700;margin-bottom:.45rem;">${s.title}</h3> <p style="font-size:.875rem;color:var(--txt2);line-height:1.75;">${s.desc}</p> </div> <!-- Tags --> <div style="display:flex;flex-wrap:wrap;gap:.35rem;margin-top:auto;"> ${s.tags.map((t) => renderTemplate`<span class="badge badge-indigo" style="font-size:.67rem;">${t}</span>`)} </div> </div>`)} </div> <!-- Bottom CTA --> <div style="text-align:center;margin-top:4rem;padding:2.5rem;background:var(--card2);border:1px solid var(--border);border-radius:1rem;"> <h3 style="font-size:1.25rem;font-weight:700;margin-bottom:.75rem;">Ready to work on your backend?</h3> <p style="color:var(--txt2);font-size:.9rem;margin-bottom:1.5rem;max-width:32rem;margin-left:auto;margin-right:auto;">
I'm available for freelance projects, internships, and full-time backend developer roles.
</p> <a href="/contact" class="btn btn-primary">Get In Touch</a> </div> </div> </section> ` })}`;
}, "C:/Users/sibla/Downloads/sibghatullah-laghari.github.io/src/pages/working.astro", void 0);

const $$file = "C:/Users/sibla/Downloads/sibghatullah-laghari.github.io/src/pages/working.astro";
const $$url = "/working";
